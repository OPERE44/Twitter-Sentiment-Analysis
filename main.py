...
#For convenience, first combine train and test set. This saves the trouble of performing the same steps twice on test and train.
...
# another look at the first few rows of the combined dataframe.
combi.head()
...
#tokenize all the cleaned tweets in the dataset. 
...
# store all the trend terms in two separate lists; one for non-racist/sexist tweets and the other for racist/sexist tweets.
...
#The validation score is 0.545 and the public leaderboard F1 score is 0.5303. 
